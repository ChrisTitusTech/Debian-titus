...
(define (210-glow-selection-shadow image
			drawable
			glow-radius
			feather-radius
			glow-color
...
(script-fu-register "210-glow-selection-shadow"
		    "<Image>/Script-Fu/Effects Selection/Glow Selection Shadow"
		    "Makes a \"glow\" around the outside of the current selection."
		    ...
		    SF-VALUE "Feather Radius" "20"
		    SF-COLOR "Glow Color" '(0 0 0)
